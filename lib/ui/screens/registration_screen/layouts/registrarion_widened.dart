...
class RegistrationWidened extends StatefulWidget {
  const RegistrationWidened({Key? key}) : super(key: key);

  @override
  State<RegistrationWidened> createState() => _RegistrationWidenedState();
}

class _RegistrationWidenedState extends State<RegistrationWidened> {
...
/*
class RegistrationWidened extends StatelessWidget {
  const RegistrationWidened(
      {Key? key, required this.leftRowChildren, required this.rightRowChildren})
      : super(key: key);
    ...
    return Row(
      ...
      children: [
        Expanded(
          flex: 2,
          child: CustomScrollView(slivers: [
            SliverList(delegate: SliverChildListDelegate(leftRowChildren)),
          ]),
        ),
        Expanded(
          flex: 3,
          child: Container(
            ...
            child: CustomScrollView(slivers: [
              SliverList(
                delegate: SliverChildListDelegate(rightRowChildren),
              ),
            ]),
          ),
        )
