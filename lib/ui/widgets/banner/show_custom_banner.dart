...
void showBanner(BuildContext context, String? msg, {String? actionButtonText, Function? actionButtonHandle}) {
...
MaterialBanner _buildMaterialBanner(
  ...
  return MaterialBanner(
    ...
    content: Text(txt),
    contentTextStyle: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: Colors.indigo),
    actions: [
      TextButton(
          onPressed: () {
            ScaffoldMessenger.of(context).hideCurrentMaterialBanner();
          },
          child: Text(actionButtonText != null ? 'Cancel' : 'OK', style: const TextStyle(color: Colors.purple))),
