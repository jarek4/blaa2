...
class QuizHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(title, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold), textAlign: TextAlign.start),
        Row(
  ...
  Text buildScoreNotification(bool isGuess, bool isLocked) {
    ...
    return Text(
      txt,
      style: TextStyle(fontSize: 12, fontWeight: isGuess ? FontWeight.bold : FontWeight.normal, color: Colors.green),
    );
  }
}
